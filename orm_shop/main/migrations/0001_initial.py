# Generated by Django 4.2.7 on 2025-03-11 10:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gearbox', models.CharField(choices=[('manual', 'Механика'), ('automatic', 'Автомат'), ('вариатор', 'CVT'), ('robot', 'Робот')], max_length=15)),
